...
from rl_birdview.models.sac import SAC
from rl_birdview.models.sac_policy import SacPolicy
...
multi_env_eval_configs = [
    {"host": "192.168.0.236", "port": 2012, 'carla_map': 'Town02'},
]
...
def get_env_wrapper_configs(rgb=True):
    ...
    # rgb=Trueの場合、以下の情報をenv_wrapper_configsに追加する
    if rgb:
...
if __name__ == '__main__':
    ...
    if RESUME_LAST_TRAIN:
        ...
        policy = SacPolicy(**saved_variables['policy_init_kwargs'])
